...
function makeMember(name: string, role: string): TeamMember {
  return {
    name,
    role,
...
const subTeams: SubTeam[] = [
  {
    ...
    members: [
      makeMember("Andreas Skagen", "Project Manager / Chairman of the Board"),
      makeMember("Alvar Guddingsmo", "Chief Technical Officer Hardware / Member of the Board"),
      makeMember("Axel Robert Olivier Jenssen", "Chief Financial Officer / Member of the Board"),
      makeMember("Jørgen Fjermedal", "Chief Technical Officer Software / Member of the Board"),
      makeMember("Lasse Johansen", "Deputy Project Manager / Deputy Chair of the Board"),
      makeMember("Yatavi Suresh", "Marketing Lead / Member of the Board"),
    ],
  },
  {
    id: "electronics",
    ...
    members: [
      makeMember("Tormod Kleiv Von Haffenbrädl", "Leader of Electrical Group"),
      makeMember("Birk Simen Geitanger Bønes", "Member of Electronics"),
      makeMember("Endre Fotland", "Member of Electronics"),
      makeMember("Erlend Langeggen", "Member of Electronics"),
      makeMember("Fredrik Flo", "Member of Electronics"),
      makeMember("Oliver Bormark Sæther", "Member of Electronics"),
      makeMember("Peder Anton Rustadbakken", "Member of Electronics"),
      makeMember("Vikingur Sigurdsson", "Member of Electronics / Member of Embedded"),
      makeMember("Øystein Romundstad Gjessing", "Member of Electronics"),
    ],
  },
  {
    id: "mechanical",
    ...
    members: [
      makeMember("Nora Aasbo Heiberg", "Leader of Mechanical Group"),
      makeMember("Eirik Skage", "Member of Mechanical"),
      makeMember("Igor Nachman", "Member of Mechanical"),
      makeMember("Levi Ivan Wangensteen", "Member of Mechanical"),
      makeMember("Luckra Yaempryong", "Member of Mechanical"),
      makeMember("Martine Solberg", "Member of Mechanical"),
      makeMember("Niclas Svardal", "Member of Mechanical"),
      makeMember("Simen Lund Gronli", "Member of Mechanical"),
      makeMember("Torkil Sand Torvanger", "Member of Mechanical"),
    ],
  },
  {
    id: "web-development",
    ...
    members: [
      makeMember("Weixin Lu", "Leader of Web Development Group / Member of Marketing"),
      makeMember("Ashish Bhardwaj", "Member of Web Development"),
      makeMember("Biraveen Gnanasampanthan", "Member of Web Development"),
      makeMember("Ricardo Sonda Guiraudeli", "Member of Web Development"),
    ],
  },
  {
    id: "software",
    ...
    members: [
      makeMember("Tristan E. Wolfram", "Software Lead"),
    ],
  },
  {
    id: "control",
    ...
    members: [
      makeMember("Cyprian Osinski", "Leader of Control Group"),
      makeMember("Ahmed Borchani", "Member of Control"),
      makeMember("Akira Techapattaraporn", "Member of Control"),
      makeMember("Anbit Adhikari", "Member of Control"),
      makeMember("Filip Nilsen", "Member of Control"),
      makeMember("Henrik Mæland Haakenaasen", "Member of Control"),
      makeMember("Patrick A. Sheehan", "Member of Control"),
      makeMember("Thomas Paulsen", "Member of Control"),
    ],
  },
  {
    id: "autonomy",
    ...
    members: [
      makeMember("Jorgen Fjermedal", "CTO Software / Member of the Board"),
      makeMember("Hinthujan Thigarajah", "Member of Autonomy"),
      makeMember("Sina Aanstad", "Member of Autonomy"),
    ],
  },
  {
    id: "perception",
    ...
    members: [
      makeMember("Andreas Kluge Svendsrud", "Leader of Perception Group"),
      makeMember("Anton Tran", "Member of Perception"),
      makeMember("Gard Eltvik Gronnerod", "Member of Perception"),
      makeMember("Jens Christian Aanestad", "Member of Perception"),
      makeMember("Mads Engesvoll", "Member of Perception"),
      makeMember("Ole Agaton Ellingsberg Helmers", "Member of Perception"),
      makeMember("Sophia Mina Friedensburg", "Member of Perception"),
    ],
  },
  {
    id: "embedded",
    ...
    members: [
      makeMember("Alvar Guddingsmo", "Embedded Lead"),
    ],
  },
  {
    id: "admin",
    ...
    members: [
      makeMember("Lasse Johansen", "Deputy Project Manager / Deputy Chair of the Board"),
      makeMember("Ole Alexander Vimo Herrem", "Member of Admin"),
      makeMember("Ravn Nordling Tonnesen", "Member of Admin"),
      makeMember("Waldemar Riiser", "Member of Admin"),
    ],
  },
  {
    id: "gui",
    ...
    members: [
      makeMember("Jorgen Fjermedal", "CTO Software / Member of the Board"),
      makeMember("Eirik Stokker Aksdal", "Member of GUI"),
      makeMember("Jonas Rundfloen", "Member of GUI"),
    ],
  },
 {
    id: "marketing",
    ...
    members: [
      makeMember("Yatavi Suresh", "Leader of Marketing Group / Member of the Board"),
      makeMember("Iver Haddal", "Member of Marketing"),
      makeMember("Julie Qiao Hall", "Member of Marketing"),
      makeMember("Weixin Lu", "Member of Marketing / Leader of Web Development"),
    ],
  },
];
